// {
    ...
    db.serialize(function() {
      ...
      db.run("INSERT INTO user VALUES ('Wings', 'oreo', 'Wings')");
      db.run("INSERT INTO user VALUES ('Josue', 'oreo1234', 'Josué')");      
    });
    // }
    app.post('/login', function (req, res) {
        ...
        db.get(query , function(err, row) {
            ...
            if(err) {
                ...
                res.send('Prevenir un SQL injection usando consultas parametrizadas ' + row.name + '</b><br /><a href="/index.html">Login</a>');
            }
        });
